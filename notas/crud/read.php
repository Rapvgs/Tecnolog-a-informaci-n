...
?>
    <table class="table table-striped table-hover bg-light" id="tabla">

    <tr class="table-dark"><td hidden>ID</td><td>Nombre</td><td>Nota1</td><td>Nota2</td><td>Nota3</td><td>Nota4</td><td>Editar</td> </tr>
                        ...
                        <tr>
                            ...
                            <a href="frm_update.php?id=<?php echo $row['id']?>">
                              ...
                              <a href="crud/delete.php?id=<?php echo $row['id'] ?>  ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16" id="ico-borrar">
